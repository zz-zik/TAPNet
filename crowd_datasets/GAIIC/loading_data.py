...
from crowd_datasets.GAIIC.GAIIC import GAIIC, show_image
...
def loading_data(data_root, modal, aug_dict):
    ...
    train_set = GAIIC(data_root, modal, rgb_transform=rgb_transform,
    ...
    val_set = GAIIC(data_root, modal, rgb_transform=rgb_transform,
...
if __name__ == '__main__':
    data_root = '/sxs/zhoufei/P2PNet/GAIIC2024'
